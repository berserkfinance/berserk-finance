...
contract LPTokenWrapper {
    ...
    IERC20 public y = IERC20(0xD7ACd2a9FD159E69Bb102A1ca21C9a3e3A5F771B);
...
contract BerserkETHPool is LPTokenWrapper, IRewardDistributionRecipient {
    IBerserkToken public berserk = IBerserkToken(0xd8b934580fcE35a11B58C6D73aDeE468a2833fa8); 

    uint256 public  DURATION = 1 weeks;
    uint256 public  NUMBER_EPOCHS = 100000000;

    uint256 public  EPOCH_REWARD = 6 ether;
    ...
    uint256 public starttime = 1604502080;
    ...
    modifier checkNextEpoch() {
        if (block.timestamp >= periodFinish) {
            ...
            if (currentEpoch==2){
                currentEpochReward= EPOCH_REWARD.mul(7);
                DURATION= 2 weeks;
            }
